...
while (match = search.exec(query)) queryString[decode(match[1])] = decode(match[2]);
...
FoundationHelper.prototype = {
  ...
  getCurrentSizeClass: function getCurrentSizeClass() {
    var self = this;
  ...
  registerSizeClassChangeListener: function registerSizeClassChangeListener(onSizeClassChange) {
    var self = this;
  ...
  registerSizeClassKnownListener: function registerSizeClassKnownListener(onSizeClassKnown) {
    var self = this;
